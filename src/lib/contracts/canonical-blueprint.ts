    ...
    testing_plan: z.object({
      ...
      benchmarks: z.object({
        conversion_benchmarks: z.object({
          ...
          industry_average_cvr: z.number().nullable(),
          industry_average_ctr: z.number().nullable(),
          target_cpa: z.number().nullable(),
          performance_targets: z.object({
            week_1: z.object({ cvr: z.number().nullable(), ctr: z.number().nullable() }),
            week_2: z.object({ cvr: z.number().nullable(), ctr: z.number().nullable() }),
            week_3_plus: z.object({ cvr: z.number().nullable(), ctr: z.number().nullable() }),
          }),
          source: z.string(),
          confidence: z.number().min(0).max(1),
          reasoning: z.string(),
      ...
      market_context: z.object({
        ...
        competitor_analysis: z.object({
          status: z.enum(['available', 'unavailable']),
          competition_level: z.enum(['low', 'medium', 'high', 'unavailable']),
          estimated_cpc_range: z.object({ low: z.number().nullable(), high: z.number().nullable() }),
