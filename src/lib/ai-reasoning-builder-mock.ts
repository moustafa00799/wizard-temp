...
function baseReasoning(locale: "ar" | "en"): AIReasoningContract {
  ...
  return {
    ...
    decision_explanations: [
      {
        decision_ref: "decisions.objective",
        what_decided: english ? "Keep the selected objective as the CDKS objective." : "الإبقاء على الهدف المختار باعتباره هدف CDKS.",
        why_this_fits: english ? "It is directly grounded in the submitted objective and the deterministic policy output." : "لأنه مستند مباشرة إلى الهدف المدخل وإلى مخرج السياسة الحتمية.",
        expected_effect: english ? "This should keep planning aligned with the stated business outcome; it is not a performance guarantee." : "من المتوقع أن يحافظ ذلك على اتساق التخطيط مع النتيجة التجارية المطلوبة؛ وليس ضمانًا للأداء.",
        tradeoffs: [english ? "A narrower objective can reduce flexibility for secondary outcomes." : "قد يقلل الهدف الأكثر تحديدًا المرونة تجاه النتائج الثانوية."],
        risks: [english ? "If the business priority changes, the plan may no longer fit." : "إذا تغيرت الأولوية التجارية فقد لا تعود الخطة مناسبة."],
        what_would_change_it: [english ? "A confirmed change in the primary business objective." : "تأكيد تغيير الهدف التجاري الأساسي."],
        next_validation_step: english ? "Confirm the objective and review the first measurement event before approval." : "أكد الهدف وراجع أول حدث قياس قبل الاعتماد.",
        evidence_refs: ["evidence-objective"],
        uncertainty_refs: [],
      },
      {
        decision_ref: "readiness",
        what_decided: english ? "Keep readiness as a review gate, not launch authorization." : "الإبقاء على الجاهزية كحاجز مراجعة وليس إذن إطلاق.",
        why_this_fits: english ? "The readiness rule records that final inputs are not confirmed." : "لأن قاعدة الجاهزية تسجل أن المدخلات النهائية غير مؤكدة.",
        expected_effect: english ? "This should reduce the risk of treating an unverified setup as launch-ready; no outcome is promised." : "من المتوقع أن يقلل ذلك خطر اعتبار إعداد غير متحقق منه جاهزًا للإطلاق؛ ولا يعد بنتيجة.",
        tradeoffs: [english ? "The additional review step adds time before any future launch decision." : "تضيف خطوة المراجعة وقتًا قبل أي قرار إطلاق مستقبلي."],
        risks: [english ? "Skipping confirmation can invalidate the interpretation of the plan." : "قد يؤدي تجاوز التأكيد إلى إضعاف صلاحية تفسير الخطة."],
        what_would_change_it: [english ? "Confirmed tracking, offer, and operating inputs from the human reviewer." : "تأكيد التتبع والعرض ومدخلات التشغيل من المراجع البشري."],
        next_validation_step: english ? "Complete the readiness checklist and record human approval before preparation." : "أكمل قائمة الجاهزية وسجل الاعتماد البشري قبل التحضير.",
        evidence_refs: ["evidence-readiness"],
        uncertainty_refs: ["uncertainty-confirmation"],
      },
    ],
