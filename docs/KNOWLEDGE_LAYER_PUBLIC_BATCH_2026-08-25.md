...
تم استنفاد مجموعة كبيرة من المصادر العامة القابلة للوصول دون صلاحيات خاصة، ثم تحويلها إلى snapshots وSource Records وEvidence Packages قابلة لإعادة البناء. توسعت Registry من 9 إلى **56 مصدرًا مسجلًا**، وأصبح الـmanifest يضم **25 artifact عامًا إضافيًا** فوق World Bank وCAPMAS وGoogle Trends. أُبقيت ملفات HTML وPDF وCSV/JSON الخام الكبيرة في التخزين المحلي مع hashes وروابط إعادة التنزيل، ولم تُضمّن عشوائيًا في Git.
...
| KAPSARC/SAMA | 2,992 ملاحظة قطاعية، و44 قطاع/مدينة، و32 ملاحظة تفصيلية حديثة؛ أضيفت 2,688 ملاحظة منشآت | نشاط دفع إجمالي وعرض منشآت حسب النشاط والحجم للسعودية | لا يثبت أن النشاط إلكتروني بالكامل ولا يربط إعلانًا بتحويل؛ سلسلة المنشآت تاريخية 2010–2017 |
...
| CAPMAS HIECS 2021 | ملاحظتان metadata | نطاق مسح دخل وإنفاق واستهلاك الأسر ومتغير النشاط الاقتصادي | microdata موسومة Licensed؛ لا population estimates أو ecommerce demand |
| OpenStreetMap/Overpass | 12 ملاحظة مجمعة للقاهرة والرياض | supply/discovery context للمدارس والجامعات والحضانات والعيادات والمستشفيات | mapped features وليست census أو demand؛ ODbL attribution مطلوب |
...
|---|---:|
| Source Registry وSourceRecord parsing | PASS؛ 56 مصدرًا |
| public ingestion regression | PASS؛ 125 assertion |
